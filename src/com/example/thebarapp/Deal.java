...
public class Deal {
	...
	public Integer getUpVotes(){return up_votes;}
	
	public Integer getDownVotes(){return down_votes;}
	...
	public void setDetails(String val){details = val;}
	
	public void setRestrictions(String val){restrictions = val;}
	...
	public void addUpVote(){up_votes++;}
	
	public void addDownVote(){down_votes++;}
	
	public void setLatitude(String val){lat = Double.parseDouble(val);}
	
	public void setLongitude(String val){lng = Double.parseDouble(val);}
}
